...
const HomePage = () => (
  <>
    <Helmet>
      <title>Rashmi Photography - Storytelling Through The Lens</title>
    ...
    <div className="section-padding pt-32 min-h-screen text-center">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto mb-8">
        Capturing elegant and timeless moments for weddings, portraits, and editorials. Based in New York, available worldwide.
      </p>
